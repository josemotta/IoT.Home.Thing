...
- **Lirc**: The Linux Infrared Remote Control for Raspberry Pi is installed at `home-srv`, extending the `Thing` web service to support IR remotes and their respective codes at `RemoteApi`.
